package com.example.nfc_wr.update;
...
public class UpdateManager {
	...
	private boolean isUpdate() {
		...
		try {
			...
			// 包装成url的对象
			// URL url = new URL(
			// "http://125.216.217.220:8080/1/version.xml");
			...
			ParseXmlService service = new ParseXmlService(mContext);
		...
		if (null != mHashMap) {
			...
			Toast.makeText(mContext,
					"当前版本号" + versionCode + "最新版本号" + serviceCode,
	...
	private void showDownloadDialog() {
		...
		View v = inflater.inflate(R.layout.download_new_version, null);
		...
		// mProgress.setMessage(mContext.getText(R.string.soft_updating));
